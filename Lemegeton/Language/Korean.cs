...
namespace Lemegeton.Language
{
    ...
    internal class Korean : Core.Language
    {
        ...
        public Korean(State st) : base(st)
        {
            ...
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM", "(P5) 코드: **미* (시그마) 오토마커");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Enabled", "활성화");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/SelfMarkOnly", "나에게만 징 달기");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/AsSoftmarker", "클라이언트 측의 소프트 마커 사용하기");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Signs", "마커 설정");
            ...
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Signs/DistantWorld", "핼로월드: 원거리");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Signs/NearWorld", "핼로월드: 근거리");
            ...
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Prio", "우선 순위 설정");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Test", "랜덤 할당 테스트");
