...
namespace Lemegeton.Language
{
    ...
    internal class Japanese : Core.Language
    {
        ...
        public Japanese(State st) : base(st)
        {
            ...
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM", "(P5) コード：＊＊＊ミ＊【シグマ】オートマーカー");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Enabled", "有効");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/SelfMarkOnly", "自分にのみマーキングする");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/AsSoftmarker", "クライアント側のソフトマーカーとして表示する");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Signs", "マーカー設定");
            ...
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Signs/Arm1", "アーム誘導 1");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Signs/Arm2", "アーム誘導 2");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Signs/DistantWorld", "ハローワールド:ファー");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Signs/NearWorld", "ハローワールド:ニアー");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Signs/DistantFarBait", "遠くでファー誘導");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Signs/DistantCloseBait", "近くでファー誘導");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Signs/NearBait1", "ニアー誘導 1");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Signs/NearBait2", "ニアー誘導 2");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Prio", "優先度設定");
            AddEntry("Content/Ultimate/UltOmegaProtocol/DynamisSigmaSecondAM/Test", "ランダムに割り当てテスト");
